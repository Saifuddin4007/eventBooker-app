...
const Home = () => {
    ...
    const timeoutId = setTimeout(async () => {
        try {
            setLoading(true); // 👈 also reset loading on each new search
    ...
    return () => clearTimeout(timeoutId);
}, [search]); // fetchEvents no longer needed in deps since it's inline
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <footer className="mt-auto pt-16 pb-8 border-t border-gray-200 text-center">
                ...
                <div className="text-xs text-gray-400 font-medium uppercase tracking-wider">
                    &copy; {new Date().getFullYear()} EventBooker Platform. All rights reserved.
                </div>
            </footer>
        </div>
    );
